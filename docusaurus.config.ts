...
const config: Config = {
  ...
  customFields: {
    bio: '道阻且长，行则将至',
    description:
      '是一个由路漫漫创建的个人博客，主要分享编程开发知识和项目，该网站基于 React 驱动的静态网站生成器 Docusaurus 构建。',
  },
  themeConfig: {
    // announcementBar: {
    ...
    footer: {
      ...
      copyright: `<p>Copyright © 2023 - ${new Date().getFullYear()} lumm. | Built with Docusaurus.</p>`,
    },
    algolia: {
      appId: '1NL5WSDYRP',
    ...
    [
      './src/plugin/plugin-content-blog', // 为了实现全局 blog 数据，必须改写 plugin-content-blog 插件
      {
        ...
        feedOptions: {
          type: 'all',
          title: '路漫漫',
          copyright: `Copyright © ${new Date().getFullYear()} 路漫漫 Built with Docusaurus.`,
        },
      },
    ],
