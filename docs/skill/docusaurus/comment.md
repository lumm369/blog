...
本博客已经内置好评论组件 [src/component/Comment](https://github.com/lumm369/blog/blob/main/src/components/Comment/index.tsx)，所以只需要在 `docusaurus.config.ts` 中设置 giscus 的配置即可。
