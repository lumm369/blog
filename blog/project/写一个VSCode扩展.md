...
开源地址：[kuizuo/vscode-extension (github.com)](https://github.com/lumm369/vscode-extension)
...
![](https://img.lummstudio.com/image_StiMqQrFCi.png)
...
![](https://img.lummstudio.com/image_Yv4X32qLE5.png)
...
export function activate(context: vscode.ExtensionContext) {
  vscode.window
    .showInformationMessage('是否要打开路漫漫的小站？', '是', '否', '不再提示')
    .then(result => {
      if (result === '是') {
        exec(`start 'https://lummstudio.com'`)
      } else if (result === '不再提示') {
        // 其他操作 后文会说
      }
    })
...
![](https://img.lummstudio.com/image_9oqLzZl-wE.png)
...
const commandLine = os.platform() === 'win32' ? `start https://lummstudio.com` : `open https://lummstudio.com`
exec(commandLine)
```
...
![](https://img.lummstudio.com/image_teNrxe9D9O.png)
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  if (showTip) {
    ...
    if (result === '是') {
      const commandLine =
        os.platform() === 'win32' ? `start https://lummstudio.com` : `open https://lummstudio.com`
      exec(commandLine)
    } else if (result === '不再提示') {
...
![](https://img.lummstudio.com/image_3SRybBGaF1.png)
...
![](https://img.lummstudio.com/image_nQu3Y8DWSw.png)
...
![](https://img.lummstudio.com/image_SnnPUABJN5.png)
...
![](https://img.lummstudio.com/image_yQRsMkT6f5.png)
...
![](https://img.lummstudio.com/image_-ZCy88xVyq.png)
...
![](https://img.lummstudio.com/image_RUIjdDI90l.png)
...
![](https://img.lummstudio.com/image_nVO_YmRit4.png)
...
![](https://img.lummstudio.com/token1_JNXknLPQyJ.png)

**2、新建一个 token**

![image-20220831152146541](https://img.lummstudio.com/image-20220831152146541.png)
...
![](https://img.lummstudio.com/image_HssaMdar8f.png)
...
![vscode-extension](https://img.lummstudio.com/image-20220711195038039.png)
