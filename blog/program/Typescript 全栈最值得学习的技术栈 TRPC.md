...
image: https://img.lummstudio.com/trpc-banner.png
...
在线体验地址：[TRPC demo](https://trpc.lummstudio.com/)
...
![image-20230308142331808](https://img.lummstudio.com/image-20230308142331808.png)
...
![image-20230308142452678](https://img.lummstudio.com/image-20230308142452678.png)
...
![](https://img.lummstudio.com/image_YDKc7TixQA.png)
...
![](https://img.lummstudio.com/image_WfW8ehqUKz.png)

![](https://img.lummstudio.com/image_qicvoGjshx.png)
...
![](https://img.lummstudio.com/20230307214659.png)
...
![](https://img.lummstudio.com/image_ufrhaugaIj.png)

![](https://img.lummstudio.com/image_cvlDJjhwPl.png)

分别输出三者 result 也没有任何问题。

![](https://img.lummstudio.com/image_hbL8So_RzB.png)
...
![](https://img.lummstudio.com/image_-qEI8jR1uM.png)

![](https://img.lummstudio.com/image_RTdWJn_55p.png)
...
![](https://img.lummstudio.com/image_8BUcBPK8In.png)
...
![](https://img.lummstudio.com/image_ERGzEt2Tq8.png)
...
![](https://img.lummstudio.com/image_QBXnHdoewh.png)
...
![](https://img.lummstudio.com/image__B1RYeiFze.png)
  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials, req) {
        ...
        const user = { id: '1', name: 'kuizuo', email: 'hi@lummstudio.com' }
...
![](https://img.lummstudio.com/image_9eowvvnwU2.png)
...
![](https://img.lummstudio.com/image_7_XKmbuK87.png)
...
这里我提供了一个简单的示例，你可以 [点我](https://trpc.lummstudio.com) 访问体验一下（项目部署在 Vercel，而数据库服务在腾讯云，登录服务又依赖 Github，所以项目会稍微有那么慢）。整个项目结构大致如下

![](https://img.lummstudio.com/image_z_YaR-RnSu.png)
