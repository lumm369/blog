...
image: https://img.lummstudio.com/320f3e5a66900d68e93de38154989948.png
---
...
![](https://img.lummstudio.com/9a7412200a062646b729c8419be28b35.jpeg)

### Restful API

Restful 架构的设计范式侧重于分配 HTTP 请求方法（GET、POST、PUT、PA TCH、DELETE）和 URL 端点之间的关系。如下图

![](https://img.lummstudio.com/17fc41e2de8d829dc2d41e31a0775df3.png)
...
![](https://img.lummstudio.com/image_Y4u9tNpZwR.png)
...
![](https://img.lummstudio.com/8a141ec5fa73781d66fb2e1b60f9b49d.jpg)
...
![](https://img.lummstudio.com/image_kvWUNtlUbf.png)

查询 personID 为 1 的 Person 并且只获取 `name`，`gender`，`height` 字段

![](https://img.lummstudio.com/image_Msg9xwWFrl.png)

查询 personID 为 2 的 Person 并且只获取 `name`，`eyeColor`、`skinColor`、`hairColor` 字段

![](https://img.lummstudio.com/image_hX0l36Acme.png)
...
![](https://img.lummstudio.com/image_Z0b6ya-auG.png)
...
仓库本文实例代码仓库： [kuizuo/nest-graphql-demo](https://github.com/lumm369/nest-graphql-demo 'kuizuo/nest-graphql-demo')
...
![](https://img.lummstudio.com/image_a3yl4oVtSU.png)

此时点击执行，可以得到右侧结果，即`app.resolver.ts` 中 `hello` 函数所定义的返回体。

![](https://img.lummstudio.com/image_bK9bvZ3QMm.png)
...
![](https://img.lummstudio.com/image_L9yYAn78Dw.png)
...
![](https://img.lummstudio.com/image_XemqTcfz_D.png)
...
![](https://img.lummstudio.com/image_sJCQpllOXK.png)
...
![](https://img.lummstudio.com/image_7-twN56Aym.png)
...
![](https://img.lummstudio.com/image_NPqShDN3Pl.png)

#### 修改

![](https://img.lummstudio.com/image_c4ycwRs-po.png)

#### 删除

![](https://img.lummstudio.com/image_xpkHhpS1-K.png)
...
这里我就选用 [kuizuo/vitesse-nuxt-strapi](https://github.com/lumm369/vitesse-nuxt-strapi 'kuizuo/vitesse-nuxt-strapi') 作为演示，并为其提供 graphQL 支持。
...
![](https://img.lummstudio.com/image_4GFUs8CmQJ.png)

#### 查询 id 为 2 的 todo

![](https://img.lummstudio.com/image_NMM4e3L_y8.png)

#### 查询 id 为 2 的 todo 并只返回 value 属性

![](https://img.lummstudio.com/image_E1eWrzjaEs.png)

#### 新增 todo

![](https://img.lummstudio.com/image_pclR7Zb6TE.png)

#### 更新 todo

![](https://img.lummstudio.com/image_g3RJL7RQWR.png)

#### 删除 todo

![](https://img.lummstudio.com/image_m7s17q2TG0.png)
